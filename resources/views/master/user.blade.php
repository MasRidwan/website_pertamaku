          ...
          <div class="col-lg-12">
            ...
            <div class="card">
              <div class="card-body">
                ...
                <a class="btn btn-sm btn-primary mb-2 box-shadow" href="javascript:;"  onclick="addUser()"id="add-user"> <i class="bi-plus"></i> Tambah data </a>
                ...
                <table class="table datatable table-hover">
                  ...
                  <tr>
                      ...
                      <td>{{ $user->email }}</td>
                      <td>
                        <a href="javascript:;" onclick="editUser('{{ $user->id}}')" id="edit-user"
                        class="btn btn-sm btn-success mb-2 box-shadow"> <i class="bi-pencil"></i> </a>
                        <a href="javascript:;" class="btn btn-sm btn-danger mb-2 box-shadow"
                        onclick="deleteUser('{{ $user->id }}')"> <i class="bi-trash"></i> </a>
                      </td>
                    </tr>
                    @endforeach
                  </tbody>
